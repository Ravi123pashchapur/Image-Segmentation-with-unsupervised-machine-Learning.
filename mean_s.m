function [clustCent,data2cluster,cluster2dataCell] = mean_s(dataPts,bandwidth,threshold);
...
threshold_convergence =  threshold; 
 ...
 % Tracking: if a points been seen already
tracking_array= false(1,no_data_dataset);
% Number of points to posibaly use as initilization points
no_point_4_initial = no_data_dataset; 
